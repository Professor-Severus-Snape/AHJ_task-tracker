...
function Tasks_typeof(o) { "@babel/helpers - typeof"; return Tasks_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, Tasks_typeof(o); }
function Tasks_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, Tasks_toPropertyKey(o.key), o); } }
function Tasks_createClass(e, r, t) { return r && Tasks_defineProperties(e.prototype, r), t && Tasks_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function Tasks_toPropertyKey(t) { var i = Tasks_toPrimitive(t, "string"); return "symbol" == Tasks_typeof(i) ? i : i + ""; }
function Tasks_toPrimitive(t, r) { if ("object" != Tasks_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != Tasks_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function Tasks_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
var Tasks = /*#__PURE__*/Tasks_createClass(
// <div class="tasks"></div>
function Tasks() {
  Tasks_classCallCheck(this, Tasks);
...
function MainTitle_typeof(o) { "@babel/helpers - typeof"; return MainTitle_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, MainTitle_typeof(o); }
function MainTitle_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, MainTitle_toPropertyKey(o.key), o); } }
function MainTitle_createClass(e, r, t) { return r && MainTitle_defineProperties(e.prototype, r), t && MainTitle_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function MainTitle_toPropertyKey(t) { var i = MainTitle_toPrimitive(t, "string"); return "symbol" == MainTitle_typeof(i) ? i : i + ""; }
function MainTitle_toPrimitive(t, r) { if ("object" != MainTitle_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != MainTitle_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function MainTitle_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
var MainTitle = /*#__PURE__*/MainTitle_createClass(
// <h1 class="main-title">Task tracker</h1>
function MainTitle() {
  MainTitle_classCallCheck(this, MainTitle);
...
function PinnedTasks_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, PinnedTasks_toPropertyKey(o.key), o); } }
function PinnedTasks_createClass(e, r, t) { return r && PinnedTasks_defineProperties(e.prototype, r), t && PinnedTasks_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function PinnedTasks_toPropertyKey(t) { var i = PinnedTasks_toPrimitive(t, "string"); return "symbol" == PinnedTasks_typeof(i) ? i : i + ""; }
...
function PinnedTasks_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
var PinnedTasks = /*#__PURE__*/PinnedTasks_createClass(
...
function AllTasks_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, AllTasks_toPropertyKey(o.key), o); } }
function AllTasks_createClass(e, r, t) { return r && AllTasks_defineProperties(e.prototype, r), t && AllTasks_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function AllTasks_toPropertyKey(t) { var i = AllTasks_toPrimitive(t, "string"); return "symbol" == AllTasks_typeof(i) ? i : i + ""; }
...
function AllTasks_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
var AllTasks = /*#__PURE__*/AllTasks_createClass(
// <div class="all-tasks">
...
var Controller = /*#__PURE__*/function () {
  ...
  return Controller_createClass(Controller, [{
    ...
    value: function addNewTask(text) {
      var currentTask = this.createNewTask(text);
      this.tasksList.push(_defineProperty({}, text, currentTask));
    ...
    key: "createNewTask",
    value: function createNewTask(text) {
      ...
      var taskRemoveBtn = document.createElement('div');
      taskRemoveBtn.classList.add('task__remove-btn');
      var taskRemoveBtnPin = document.createElement('div');
    ...
    key: "addPinnedTask",
    value: function addPinnedTask(text) {
      var pinnedTask = this.createPinnedTask(text);
    ...
    key: "createPinnedTask",
    value: function createPinnedTask(text) {
      var pinnedElement = document.createElement('div');
      ...
      var taskBtn = document.createElement('div');
      taskBtn.classList.add('task__btn');
      var taskBtnPin = document.createElement('div');
    ...
    value: function sort() {
      var _this = this;
      this.showTasks();
      var filterList = this.allTasksList.filter(function (str) {
        return str.startsWith(_this.taskText);
      });

      // this.tasksList = [ { текст заметки: заметка }, { текст заметки: заметка } ... ]
      this.tasksList.forEach(function (obj) {
        Object.entries(obj).forEach(function (_ref) {
          ...
          if (!filterList.includes(key)) {
            ...
            if (!filterList.length) {
              _this.noTasks.classList.remove('hidden');
            } else {
              _this.noTasks.classList.add('hidden');
            }
          }
        });
      });
      ...
      this.tasksList.forEach(function (obj) {
        Object.entries(obj).forEach(function (_ref3) {
          var _ref4 = _slicedToArray(_ref3, 2),
            key = _ref4[0],
            value = _ref4[1];
          _this2.allTasksList.forEach(function (text) {
            if (text === key) {
    ...
    value: function onClick(event) {
      ...
      (_this$pinnedTasksList = this.pinnedTasksList).push.apply(_this$pinnedTasksList, _toConsumableArray(this.allTasksList.splice(allTaskIndex, 1)));

      // 2. удаляем объект вида { текст заметки: заметка } из общего массива this.tasksList:
      var taskIndex = this.tasksList.findIndex(function (obj) {
      ...
      var taskBtn = task.querySelector('.task__btn');
    ...
    value: function onClickPin(event) {
      ...
      var taskBtnPin = task.querySelector('.task__btn_pin');
